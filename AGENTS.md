...
All product requirements live in `docs/specs/`. Demo screen inventory (Checkpoint 1A-derived) is in [docs/specs/demo.md](docs/specs/demo.md). Long-term client asks and competitor reference are in [docs/specs/vision.md](docs/specs/vision.md). Update specs when decisions are made; do not rely on chat history alone.
